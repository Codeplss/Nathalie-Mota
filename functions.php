...
function enqueue_custom_scripts() {
    ...
    wp_enqueue_script('lightbox-fullscreen', get_template_directory_uri() . '/js/lightbox-fullscreen.js', array('jquery'), '1.0', true); // Charge les scripts de lightbox pour la photo unique
    wp_enqueue_script('lightbox-home', get_template_directory_uri() . '/js/lightbox-home.js', array('jquery'), '1.0', true); // Charge les scripts de lightbox pour la photo unique
